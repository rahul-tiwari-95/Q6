...
function renderBanksComparison(){
  ...
  renderBanksComposition();renderBanksExposure();renderBanksActions();renderBanksBootstrap();renderBanksGraph();selectBanksTrajectory();
}
