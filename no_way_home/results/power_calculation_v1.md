...
**Not N=5.** Recommend N=30 seeds/arm: matches the existing project convention (provenance_test_v1.md, election_test_v1.md both use 30), clears detection power with enormous margin (>99% against the pilot's smoothed effect size), and gets the Wilson upper bound on a zero-observed arm down to ~11% -- still not razor-precise, but a defensible basis for a knee-location claim, unlike N=5-10. This is a recommendation for Rahul's sign-off, not a locked pre-registration.
